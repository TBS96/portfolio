        ...
        <section className='py-16 px-6 md:px-20 font-medium my-5 shadow-2xs hover:shadow-2xl transition glass'>
            ...
            <div className='max-w-5xl mx-auto bg-gray-800/10 p-6 rounded-lg shadow-lg mb-6'>
                ...
                <ul className='list-disc list-inside space-y-2 text-lg'>
                    <li className=' transition' data-aos='fade-up' data-aos-delay='700'>
                    ...
                    <li className=' transition' data-aos='fade-up' data-aos-delay='600'>
                    ...
                    <li className=' transition' data-aos='fade-up' data-aos-delay='500'>
                        Optimized web performance, improving <span className='font-bold text-primary'>load times & user engagement</span>.
                    </li>
                    <li className=' transition' data-aos='fade-up' data-aos-delay='400'>
                    ...
                    <li className=' transition' data-aos='fade-up' data-aos-delay='300'>
            ...
            <div className='max-w-5xl mx-auto text-center bg-gray-800/10 p-6 rounded-lg shadow-lg'>
                ...
                <div className='max-w-3xl mx-auto mt-6'>
                    ...
                    <p className='text-lg leading-relaxed mt-4' data-aos='fade-up' data-aos-delay='700'>
