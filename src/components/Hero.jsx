    ...
    return (
        <section className='min-h-screen relative flex flex-col-reverse md:flex-row items-center justify-center md:justify-between px-6 md:px-12 lg:px-24 pb-10 bg-blue-900/30 shadow-2xs hover:shadow-2xl transition'>
            ...
            <div className='space-y-5 text-center md:text-left max-w-lg'>
                <p className='text-xl font-semibold mt-4 md:mt-0'>Hi, I'm Prantik Ghosh</p>
                <h1 className='text-4xl md:text-5xl font-bold'>I'm a <span className='text-red-500'>Front-end Web Developer</span></h1>
                <p>Willing to work as a <span className='font-bold'>full-time / freelance</span> developer.</p>
                ...
                <div className='flex justify-between md:justify-around space-x-4 mt-4'>
                    ...
                    <Link to='https://www.linkedin.com/in/prantikghosh96/' className='btn btn-circle  btn-primary' target='_blank' title='LinkedIn'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="fill-current">
                            <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z" />
                        </svg>
                    </Link>
                    <Link to='mailto:prantik.g1996@gmail.com' className='btn btn-circle btn-sm btn-primary' target='_blank' title='prantik.g1996@gmail.com'>
                    ...
                    <Link to='https://x.com/9theblacksheep6' className='btn btn-circle  btn-primary' target='_blank' title='X'>
                    ...
                    <Link to='https://wa.me/918910325359' className='btn btn-circle btn-primary' target='_blank' title='WhatsApp'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" className="fill-current">
